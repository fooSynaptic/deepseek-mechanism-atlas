...
| 文章章节 | 本地延伸 |
|----------|----------|
| §3.1 MLA / V3 | [mla-latent-attention.md](../versions/mla-latent-attention.md) · [v3.md](../versions/v3.md) |
| §3.2 RLVR / GRPO | [rlvr.md](../versions/rlvr.md) · [r1.md](../versions/r1.md) |
| §3.4 V3.1 Hybrid / MLA 切换 | [v3-1.md §MLA 模式切换](../versions/v3-1.md#mla-模式切换terminus-起) |
| §4 DSA | **[lightning-indexer.md](../dsa/lightning-indexer.md)** · [dsa-sparse-attention.md](../versions/dsa-sparse-attention.md) · [dsa-logic.md](../dsa/dsa-logic.md) |
| §6 V3.2 infra | [v3-2.md](../versions/v3-2.md) · [演进总览 §3.6](./deepseek-version-lineage-20260625.md#36-deepseek-v32--v32-exp) |
| §8 mHC | [mhc-manifold-hyper-connections.md](../versions/mhc-manifold-hyper-connections.md) · [v4.md](../versions/v4.md) |
