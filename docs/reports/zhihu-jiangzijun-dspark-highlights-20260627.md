...
[加速比粗式](../versions/dspark-speculative-decoding.md#4-草稿范式总览eagle3--dflash--mtp--dspark)：
...
[图示详情](../versions/figures/dspark-semi-ar-draft.svg)
...
| **draft 侧算力** | **几乎不减**。并行主干往往仍生成完整 $K$ 块草稿；截断只省 **[verify 侧](../versions/dspark-speculative-decoding.md#11-局限与边界)**。 |
...
[图示详情](../versions/figures/dspark-confidence-scheduler.svg)
...
[图示详情](../versions/figures/mtp-fusion-scheme.svg) · [投机对照总览（旧图）](../versions/figures/mtp-speculative.svg)

<img src="../versions/figures/mtp-draft-chain-depth.svg" alt="MTP draft 串行链：共享 OutHead，链深度 0/1/2 逐步 Emb 注入" width="920"/>

[图示详情](../versions/figures/mtp-draft-chain-depth.svg) · [专文 §1.1 理解对照](../versions/qa/mtp-fusion-scheme.md#11-你的理解对在哪里错在哪里)
...
<img src="../figures/rl/dspark-draft-target-parallel.svg" alt="离线 SFT target 与 draft 蒸馏并行；在线 draft+verify 加速" width="720"/>

[图示详情](../figures/rl/dspark-draft-target-parallel.svg)
...
| MTP 中间 token 融合 | [MTP 融合 scheme](../versions/qa/mtp-fusion-scheme.md) · [SVG](../versions/figures/mtp-fusion-scheme.svg) |
