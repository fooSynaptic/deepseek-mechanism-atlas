...
| [DeepSeek Harness](../versions/ds-harness.md) | **Agent 运行时** | Cordis 插件化 coding agent；与算法 / infra / MoE 三线并列 |
| [DeepSeek-V4.1-Flash](../versions/v4-1-flash.md) | **版本梗概** | CED · CSA2 · FP4 KV · SWA Bounded Replay |
