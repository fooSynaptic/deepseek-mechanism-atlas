...
| **架构-train** | 为**训练**改结构或训推系统 | [MoE 路由](../versions/aux-loss-free-moe-routing.md)（[DeepSeekMoE](../versions/deepseek-moe.md)）、[MTP 辅助头](../versions/v3.md#三mtp-multi-token-predictionv3-新增顶层结构)、[mHC](../versions/mhc-manifold-hyper-connections.md)、[Muon](../versions/v4.md)、[FP8 训推数值](../versions/v3-fp8-dynamic-quantization.md)、[DSA](../versions/dsa-sparse-attention.md) / [CSA](../versions/v4.md) 等需重训的算子 |
...
**版本 / 工作一览**（链到正文；中间三列为占比 **%**，多轴合计 100；`—` 表示该轴无贡献；**产出机构**为论文/开源/部署的主要归属；**发表时间**为 arXiv / 技术报告 / 开源或部署实践的代表月份，同版多项合并时取该工作首次公开时间）：

| 工作 | 模型 % | 架构-train % | 架构-infer % | 产出机构 | 发表时间 | 说明 |
|------|:------:|:------------:|:------------:|----------|:--------:|------|
| [V1](../versions/v1.md) scaling / BBPE / SFT·DPO | **100** | — | — | DeepSeek | 2024-01 | [数据管线](../versions/v1.md)、[词表](../versions/v1-bbpe-tokenizer.md)、对齐（SFT/DPO）；结构为常规模型 |
...
| [Index Share](../versions/index-share.md) | — | — | **100** | [清华 + 智谱](../versions/index-share.md#技术归属先读) | 2026-03 | 跨层复用 [top-$k$ index](../dsa/index-share-logic.md) |
...
| [V4 Muon](../versions/v4.md) | — | **100** | — | DeepSeek | 2026 | [优化器替换](../versions/v4.md)，加速收敛 |
...
[直接打开 SVG](../../diagrams/deepseek-version-quick.svg)
...
[直接打开 SVG](../../diagrams/deepseek-version-lineage.svg)
...
> **各节代表图**：§3.1 scaling/BBPE · §3.2 MLA · §3.3 MoE vs V2 / MTP / FP8 · §3.4 GRPO · §3.5 MLA 模式切换 · §3.6 DSA · §3.7 V4 异构 KV + DSpark · §4 Index Share · §5.1–5.3 KV offload 三代
...
各版本一页纸梗概见 [docs/versions/](../versions/README.md)。以下为展开说明（按时间线从 V1 起）。更细的 V1→V3 脉络另见 [V1→V3 演进](./deepseek-v1-to-v3-lineage.md)。

### 3.1 [DeepSeek-LLM V1](../versions/v1.md)

> **V1 正文**：[DeepSeek-LLM V1](../versions/v1.md)（2401.02954 完整中文译文）
...
[直接打开 SVG](../figures/v1/bbpe/bbpe-process-example.svg) · [V1 BBPE 专文](../versions/v1-bbpe-tokenizer.md)
...
[直接打开 SVG](../figures/mla/mla-forward-flow.svg) · [公式与符号详解](../versions/mla-latent-attention.md#forward-flow)
...
**相对 V2 的架构升级**（只看 Transformer 内部；不含 DualPipe / FP8 / 推理引擎等训推系统）
...
[直接打开 SVG](../figures/v3/v3-moe-vs-v2.svg) · [MoE 详解](../versions/v3.md#v3-vs-v2-structure) · [aux-loss-free](../versions/aux-loss-free-moe-routing.md) · [MLA 前向流程图](../versions/mla-latent-attention.md#forward-flow)

- **训练**：14.8T tokens；后训练含 SFT + RL（**R1** 为同架构 + [RLVR](../versions/rlvr.md)）。

**训练 infra（非模型结构）**：[FP8 动态量化](../versions/v3-fp8-dynamic-quantization.md) — 块级 scale + 每 $N_c{=}128$ MMA 提升 FP32 累加（论文 Figure 7）；与 DualPipe / DeepEP 并列，支撑 671B 预训练吞吐与数值稳定。
...
**训练管线**：[deepseek-r1/training-pipeline.md](../material/papers/deepseek-r1/training-pipeline.md)
...
[直接打开 SVG](../figures/rl/grpo-vs-ppo.svg) · [RLVR 详解](../versions/rlvr.md) · [GRPO 算法](../versions/rlvr.md#grpo)
...
**MLA 模式切换**（V3.1-Terminus 起，[MHA/GQA/MQA 对照](../versions/v3-1.md#mla-模式切换terminus-起)）：
...
[直接打开 SVG](../figures/v3/mla-mode-switch.svg) · [V3.1 专节](../versions/v3-1.md#mla-模式切换terminus-起)
...
> **逻辑详解**：[../dsa/dsa-logic.md](../dsa/dsa-logic.md) · [DSA 导读](../versions/dsa-sparse-attention.md)

<img src="../dsa/diagrams/dsa-pipeline.svg" alt="DSA 两阶段：Lightning Indexer 选 Top-k=2048，Core MLA 仅读 Latent-Cache 子集" width="920"/>

[直接打开 SVG](../dsa/diagrams/dsa-pipeline.svg) · [DSA 逻辑详解](../dsa/dsa-logic.md)
...
因此 V3.2 的 cache **分裂为两类**（[异构 KV](../versions/dsa-sparse-attention.md#异构-kv-cache) · [dsa-logic §4](../dsa/dsa-logic.md#4-异构-kv-cacheindexer-cache-与-latent-cache)）：
...
[直接打开 SVG](../figures/v4/v4-hetero-kv.svg) · [V4 梗概](../versions/v4.md) · [CSA/HCA 详解](../versions/csa-hca-mixed-attention.md) · [Hash MoE + FP4](../versions/hash-moe-fp4.md) · [mHC 详解](../versions/mhc-manifold-hyper-connections.md)

**1M context 效率（论文 Figure 1，相对 V3.2）**
...
> **专文**：[dspark-speculative-decoding.md](../versions/dspark-speculative-decoding.md) · [DeepSpec](https://github.com/deepseek-ai/DeepSpec)

> **Ablation 困境**：V4 同时改了注意力、残差、优化器、MoE 路由、量化精度，**很难像 V3.2 那样做单一变量对照**——这也是社区更青睐 Index Share 这类「纯 infra、零重训」补丁的原因之一。

---

## 4. [Index Share（IndexCache）](../versions/index-share.md)

> **梗概**：[Index Share](../versions/index-share.md)  
> **逻辑详解**：[../dsa/index-share-logic.md](../dsa/index-share-logic.md)
...
详见 [index-share.md §技术归属](../versions/index-share.md#技术归属先读)。
...
[直接打开 SVG](../dsa/diagrams/index-share-fffs.svg) · [Index Share 逻辑详解](../dsa/index-share-logic.md)
...
<img src="../figures/mla/mla-forward-flow.svg" alt="V3 同质 MLA Latent-Cache：每 token 仅存 c^KV + 共享 k^R（图下方 cache 对比）" width="920"/>

[直接打开 SVG](../figures/mla/mla-forward-flow.svg) · [MLA 专文 §KV Cache](../versions/mla-latent-attention.md#kv-cache-里到底存什么)
...
> **详解**：[ess-latent-cache-offload.md](../versions/ess-latent-cache-offload.md)
...
[直接打开 SVG](../dsa/diagrams/ess-dual-cache.svg) · [ESS 概念](../versions/ess-latent-cache-offload.md) · [ESS 论文梗概](../versions/ess-paper-highlights.md)
...
**收益**（仿真）：32K context 吞吐 +69.4%；128K 最高 +123%。
...
[直接打开 SVG](../figures/v4/v4-hetero-kv.svg) · [V4 §推理 infra](../versions/v4.md#推理-infra-关注点)
...
**KV layout**（论文 §3.5.1）→ **[专文：V4 KV Layout](../versions/v4-kv-layout.md)**
...
**HiSparse**（社区与 Together.ai 部署实践）→ **[专文：V4 HiSparse](../versions/v4-hisparse.md)**
...
**磁盘 Prefix Cache**（§3.5.2）→ **[专文：V4 磁盘 Prefix Cache](../versions/v4-disk-prefix-cache.md)**
...
| [DeepSeek-R1 训练管线](../material/papers/deepseek-r1/training-pipeline.md) | R1 四阶段；[RLVR 概念](../versions/rlvr.md) |
