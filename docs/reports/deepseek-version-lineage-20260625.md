...
<img src="../../diagrams/opt-direction-ternary.svg" alt="优化方向三轴分布：各工作按模型 / 架构-train / 架构-infer 占比落点" width="920"/>

[图示详情](../../diagrams/opt-direction-ternary.svg)
...
**训练管线**：[DeepSeek-R1 训练 Pipeline](../material/papers/deepseek-r1/training-pipeline.md)
...
<img src="../figures/papers/thinking-with-visual-primitives/fig-2-architecture-pipeline.png" alt="Figure 2 — V4-Flash + DeepSeek-ViT 架构与 Pretrain→SFT→RL→RFT 训练管线" width="920"/>
