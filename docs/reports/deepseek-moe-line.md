...
|------|----------|----------|----------|------|
| **① 稠密 FFN** | 全参数 SwiGLU；无稀疏激活 | V1（2024-01） | [DeepSeek-LLM V1](../versions/v1.md) | [2401.02954](https://arxiv.org/abs/2401.02954) |
| **② DeepSeekMoE** | 细粒度 routed + shared experts；softmax 路由 | V2（2024-05） | [DeepSeekMoE](../versions/deepseek-moe.md) · [DeepSeek-V2](../versions/v2.md) | [2405.04434](https://arxiv.org/abs/2405.04434) |
| **③ aux-loss-free** | sigmoid affinity + 动态 bias $b_i$；无 aux loss 主均衡 | V3（2024-12）→ V3.2 | [aux-loss-free MoE 路由](../versions/aux-loss-free-moe-routing.md) · [DeepSeek-V3](../versions/v3.md) | [2412.19437](https://arxiv.org/abs/2412.19437) §2.1 |
| **④ $L_{\mathrm{Bal}}$** | 序列内 $f_i P_i$ 互补兜底；极小 $\alpha$ | V3 起 | [序列均衡损失](../versions/moe-sequence-wise-balance-loss.md) | 同上 Eq. 17–20 |
| **⑤ Hash MoE + FP4** | 前几层 Hash-routed MoE；routed expert FP4 + QAT | V4（2026） | [Hash MoE + FP4](../versions/hash-moe-fp4.md) · [DeepSeek-V4](../versions/v4.md) | [2606.19348](https://arxiv.org/abs/2606.19348) |

> **③ 与 ④ 互补**：aux-loss-free $b_i$ 管 **ba[tch 级**主均衡；$L_{\mathrm{Bal}}$ 防 **单序列内** expert 打穿](../versions/aux-loss-free-moe-routing.md#补充-sequence-wise-auxiliary-loss-仍在)。
...
| 节点文档 | 文首应含 |
|----------|----------|
| [DeepSeekMoE](../versions/deepseek-moe.md) | `[← MoE 线导读](deepseek-moe-line.md)` |
| [DeepSeek-V2](../versions/v2.md) | `[← MoE 线导读](deepseek-moe-line.md)` |
| [DeepSeek-V3](../versions/v3.md) | 同上 |
| [aux-loss-free MoE 路由](../versions/aux-loss-free-moe-routing.md) | 同上 + 上游 DeepSeekMoE |
| [序列均衡损失](../versions/moe-sequence-wise-balance-loss.md) | 同上 + 主文档 aux-loss-free |
| [Hash MoE + FP4](../versions/hash-moe-fp4.md) | 同上 + 上游 aux-loss-free |
| [DeepSeek-V4](../versions/v4.md) | 同上 + 链 Hash MoE 专文 |

维护约定见 [版本演进线文档引用约定](../material/meta/deepseek-version-lines-crossrefs.md)。
