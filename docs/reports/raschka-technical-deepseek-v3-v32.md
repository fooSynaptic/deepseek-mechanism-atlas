...
> [← 梗概](./raschka-technical-deepseek-v3-v32-highlights.md) · [← 报告目录](./README.md)
...
| **MTP** | 推测解码相关 | 本地 [DeepSeek-V3](../versions/v3.md) |
...
| Terminus | V3.1 收尾版；128K；**V3.2 续训基座** → 见 [DeepSeek-V3.1 梗概§MLA 模式切换](../versions/v3-1.md#mla-模式切换terminus-起) |
...
> **本地延伸**：[Lightning Indexer 详解](../dsa/lightning-indexer.md) · [DSA 逻辑详解](../dsa/dsa-logic.md)
...
| Attention | GQA → [sliding window（SWA）](../versions/qa/v4-swa-sliding-window.md#行业链) → **MLA** → **sparse (DSA)** |
...
> 与 **V3.2 部署权重无直接对应**；在 **V4** 与独立论文 [mHC arXiv:2512.24880](https://arxiv.org/abs/2512.24880) 中落地（本地 [mHC 详解](../versions/mhc-manifold-hyper-connections.md) · [DeepSeek-V4](../versions/v4.md)）。
...
| 梗概 | [Raschka 要点速读](./raschka-technical-deepseek-v3-v32-highlights.md) |
| V3.1 | [DeepSeek-V3.1 梗概](../versions/v3-1.md) |
| V3.2 | [DeepSeek-V3.2 梗概](../versions/v3-2.md) |
| DSA 梗概 | [DSA稀疏注意力](../versions/dsa-sparse-attention.md) |
| DSA 逻辑 | [DSA逻辑详解](../dsa/dsa-logic.md) |
| RLVR | [RLVR](../versions/rlvr.md) |
| 演进总览 | [版本演进总览](./deepseek-version-lineage-20260625.md) |
