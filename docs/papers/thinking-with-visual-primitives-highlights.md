...
<img src="../figures/papers/thinking-with-visual-primitives/fig-2-architecture-pipeline.png" alt="Figure 2 — V4-Flash + ViT 架构与 Pretrain → SFT → RL → RFT → 蒸馏 训练管线" width="920"/>
...
| [Figure 2 — 架构与训练管线](../figures/papers/thinking-with-visual-primitives/fig-2-architecture-pipeline.png) | Figure 2 |
