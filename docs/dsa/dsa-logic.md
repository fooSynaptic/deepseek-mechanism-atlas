...
> **梗概**：[DeepSeek-V3.2 梗概](../versions/v3-2.md)
...
[图示详情](./diagrams/dsa-pipeline.svg)

### 3.1 Lightning Indexer

> **专题**：[Lightning Indexer 详解](./lightning-indexer.md)

- 用 **极低 head 维** 的点积：**当前** indexer query $q_t$ 对 **每条历史** token $s$ 的 indexer key $k_s$（Indexer-Cache 第 $s$ 行）打分，得 $I_{t,s}$（[walkthrough](./lightning-indexer.md#decode-forward-walkthrough)）。
...
- 一页梗概：[DeepSeek-V3.2](../versions/v3-2.md)
- 系列目录：[DeepSeek DSA 与 Index Share 系列](./README.md)
