...
[← 返回 §缓存访问逻辑](../engram-series-overview.md#缓存访问逻辑一次-decode-的完整路径) · [02c 时序图](../diagrams/engram-02c-cxl-cache-access.svg) · [L1–L3 存储](./cxl-l1-l2-l3-memory-tiers.md) · [答疑目录](./README.md)
