...
[engram_demo_v1.py](../../../../engram/engram_demo_v1.py) 中 `Engram.forward`（约 L358–377）：
...
- [engram-series-overview.md §Step 5–6](../engram-series-overview.md#阶段-b上下文门控与融合)
- [engram-01c-forward-dataflow.svg](../diagrams/engram-01c-forward-dataflow.svg)
- [engram_demo_v1.py](../../../../engram/engram_demo_v1.py) — `Engram.forward`
