...
[← 返回 Step 6](../engram-series-overview.md#step-6-上下文门控) · [前向总图 01c](../diagrams/engram-01c-forward-dataflow.svg) · [答疑目录](./README.md)
...
[Engram demo 脚本](../../../../engram/engram_demo_v1.py) 中 `Engram.forward`（约 L358–377）：
...
→ **短卷积 / 感受野**：[Step 7 短卷积：感受野扩充常数](./step7-short-conv-receptive-field.md)（在 **已过滤** 的 $\tilde{V}$ 上扩序列混合）

---

## 参考

- [DeepSeek Engram 系列导读§Step 5–6](../engram-series-overview.md#阶段-b上下文门控与融合)
- [engram-01c-forward-dataflow.svg](../diagrams/engram-01c-forward-dataflow.svg)
- [Engram demo 脚本](../../../../engram/engram_demo_v1.py) — `Engram.forward`
