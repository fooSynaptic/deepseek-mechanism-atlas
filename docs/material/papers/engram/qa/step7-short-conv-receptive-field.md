...
官方 demo（[Engram demo 脚本](../../../../engram/engram_demo_v1.py)）：
...
- [DeepSeek Engram 系列导读§Step 7](../engram-series-overview.md#step-7-短卷积扩感受野)
- [Engram demo 脚本](../../../../engram/engram_demo_v1.py) — `ShortConv`, `EngramConfig.kernel_size`, `max_ngram_size`
