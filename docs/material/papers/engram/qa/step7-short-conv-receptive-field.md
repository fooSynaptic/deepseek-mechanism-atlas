...
[← 返回 Step 7](../engram-series-overview.md#step-7-短卷积扩感受野) · [Step 6 门控专文](./step6-context-gating-rationale.md) · [答疑目录](./README.md)
...
官方 demo（[../../../../engram/engram_demo_v1.py](../../../../engram/engram_demo_v1.py)）：
...
- [engram-series-overview.md §Step 7](../engram-series-overview.md#step-7-短卷积扩感受野)
- [docs/engram/engram_demo_v1.py](../../../../engram/engram_demo_v1.py) — `ShortConv`, `EngramConfig.kernel_size`, `max_ngram_size`
