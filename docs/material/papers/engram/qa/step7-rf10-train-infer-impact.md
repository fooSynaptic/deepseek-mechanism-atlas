> [← 返回 Engram 系列导读](../engram-series-overview.md) · [答疑目录](./README.md) · [← 中文导读](../../../../README.md) · [← 仓库首页（EN）](../../../../../README.md)

# Step 7 感受野 1→10：训练与推理差异

[← 感受野常数](./step7-short-conv-receptive-field.md) · [Step 7 正文](../engram-series-overview.md#step-7-短卷积扩感受野)
...
- [../../../../engram/engram_demo_v1.py](../../../../engram/engram_demo_v1.py) — `ShortConv`, `value + short_conv(value)`
