...
| **Muon** | [Muon 优化器专文](./muon-optimizer.md)：矩阵正交化更新，更快收敛 |
...
| 方向 | 文档 |
|------|------|
| **MoE 线 ⑤ Hash MoE + FP4** | [Hash MoE + FP4](./hash-moe-fp4.md) |
| **MoE 线 hub** | [MoE 线导读](../reports/deepseek-moe-line.md) |
| **上游 ③④** | [aux-loss-free MoE 路由](./aux-loss-free-moe-routing.md) · [DeepSeek-V3](./v3.md) |
...
**KV layout**→ **[专文：V4 KV Layout](./v4-kv-layout.md)**（Classical + State 双池；演进总览 [§5.3](../reports/deepseek-version-lineage-20260625.md#v4-kv-layout)）

**HiSparse** → **[专文：V4 HiSparse](./v4-hisparse.md)**（inactive C4 offload；[§5.3](../reports/deepseek-version-lineage-20260625.md#v4-hisparse)）

**磁盘 Prefix Cache**→ **[专文：V4 磁盘 Prefix Cache](./v4-disk-prefix-cache.md)**（SWA 三档策略；[§5.3](../reports/deepseek-version-lineage-20260625.md#v4-disk-prefix-cache)）

**Decode 吞吐**：V4 预览引擎 → **[投机解码与 DSpark 专文](./dspark-speculative-decoding.md)**（含 MTP、MTP-1 基线、DSpark；与 HiSparse **正交**）。

> V4 的 KV-offload **[与 V3.2 ESS 完全不同](../reports/deepseek-infra-line.md#3-节点间关系一句话)**，需围绕异构压缩 cache 重新设计内存层级。
...
| **上游 ②–④** | [DSA 稀疏注意力](./dsa-sparse-attention.md) · [Index Share 梗概](./index-share.md) · [ESS Latent offload](./ess-latent-cache-offload.md) |
| **算法线 ③ CSA/HCA** | [CSA / HCA](./csa-hca-mixed-attention.md) · [算法线导读](../reports/deepseek-algorithm-line.md) |
| **MoE 线 ⑤ Hash MoE** | [Hash MoE + FP4](./hash-moe-fp4.md) · [MoE 线导读](../reports/deepseek-moe-line.md) |
...
| 方向 | 文档 |
|------|------|
| **算法线 ③ CSA/HCA** | [CSA / HCA](./csa-hca-mixed-attention.md) · [算法线导读 §1](../reports/deepseek-algorithm-line.md#1-演进链attention--残差) |
| **上游 ② DSA** | [DSA 稀疏注意力](./dsa-sparse-attention.md) |
| **并列 ④ mHC** | [mHC](./mhc-manifold-hyper-connections.md)（残差路径，与 Attention 正交） |
...
| 方向 | 关系 |
|------|------|
| 上游 | V3.2（DSA 思想延续为 CSA 内嵌 indexer；[算法线导读](../reports/deepseek-algorithm-line.md)） |
