...
> **详解**：[序列均衡损失](./moe-sequence-wise-balance-loss.md) — $f_i$、$P_i$ 如何在每条序列上统计、$f_i P_i$ 如何反传拉平负载、与 $b_i$ 的分工。
...
| **上游 ② DeepSeekMoE** | [DeepSeekMoE](./deepseek-moe.md) |
| **并列 ④ $L_{\mathrm{Bal}}$** | [序列均衡损失](./moe-sequence-wise-balance-loss.md) |
| **下游 ⑤ Hash MoE** | [Hash MoE + FP4](./hash-moe-fp4.md) · [DeepSeek-V4](./v4.md) |
...
- 本地：[序列均衡损失](./moe-sequence-wise-balance-loss.md) · [DeepSeek-V3 梗概§DeepSeekMoE](./v3.md) · [Raschka V3 导读](../reports/raschka-technical-deepseek-v3-v32-highlights.md)
