...
> **详解**：[moe-sequence-wise-balance-loss.md](./moe-sequence-wise-balance-loss.md) — $f_i$、$P_i$ 如何在每条序列上统计、$f_i P_i$ 如何反传拉平负载、与 $b_i$ 的分工。
...
| 方向 | 文档 |
|------|------|
| **本节点（③ aux-loss-free）** | [MoE 线导读 §1](../reports/deepseek-moe-line.md#1-演进链ffn--路由) |
| **上游 ② DeepSeekMoE** | [deepseek-moe.md](./deepseek-moe.md) |
| **并列 ④ $L_{\mathrm{Bal}}$** | [moe-sequence-wise-balance-loss.md](./moe-sequence-wise-balance-loss.md) |
| **下游 ⑤ Hash MoE** | [hash-moe-fp4.md](./hash-moe-fp4.md) · [v4.md](./v4.md) |
...
- 本地：[moe-sequence-wise-balance-loss.md](./moe-sequence-wise-balance-loss.md) · [v3.md §DeepSeekMoE](./v3.md) · [Raschka V3 导读](../reports/raschka-technical-deepseek-v3-v32-highlights.md)
