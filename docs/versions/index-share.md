...
| **并列 ④ ESS** | [ess-latent-cache-offload.md](./ess-latent-cache-offload.md)（Latent offload，可同开） |
| **下游 ⑤ V4** | [csa-hca-mixed-attention.md](./csa-hca-mixed-attention.md) · [v4.md](./v4.md)（V4 自带 CSA indexer，路线互补） |
...
> **逻辑详解**：[../dsa/index-share-logic.md](../dsa/index-share-logic.md) §1
...
> **逻辑详解**：[../dsa/index-share-logic.md](../dsa/index-share-logic.md) · [DSA 前置](./dsa-sparse-attention.md)
