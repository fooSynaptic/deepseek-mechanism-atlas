...
[V4 一条共享 prefix 实际包含](./v4-kv-layout.md)：
...
| **格式** | Classical KV cache 中已对齐的 **immutable 压缩块**（$\mathrm{lcm}(4,128)$ 对齐，见 [V4 KV Layout](./v4-kv-layout.md)） |
| **与 HiSparse** | 磁盘层 = **跨请求 / 跨会话** 持久；HiSparse = **单请求内** GPU↔CPU 热冷（[V4 HiSparse](./v4-hisparse.md)） |
...
| **并列 HiSparse** | [V4 HiSparse](./v4-hisparse.md) |
...
| [V4 异构 KV 总览图](../figures/v4/v4-hetero-kv.svg) | 异构 cache 总览图 |
