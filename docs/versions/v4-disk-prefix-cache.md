...
> [← 中文导读](../README.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览 §5.3 磁盘 Prefix Cache](../reports/deepseek-version-lineage-20260625.md#v4-disk-prefix-cache) · [← 基础设施线导读](../reports/deepseek-infra-line.md) · [CSA/HCA 算法专文](./csa-hca-mixed-attention.md) · [V4 梗概 §推理 infra](./v4.md#推理-infra-关注点) · [前置 KV layout](./v4-kv-layout.md) · [并列 HiSparse](./v4-hisparse.md) · [上游 ESS](./ess-latent-cache-offload.md)  
...
V4 一条共享 prefix 实际包含（见 [KV layout](./v4-kv-layout.md)）：
...
| **格式** | Classical KV cache 中已对齐的 **immutable 压缩块**（$\mathrm{lcm}(4,128)$ 对齐，见 [v4-kv-layout.md](./v4-kv-layout.md)） |
| **与 HiSparse** | 磁盘层 = **跨请求 / 跨会话** 持久；HiSparse = **单请求内** GPU↔CPU 热冷（[v4-hisparse.md](./v4-hisparse.md)） |
...
| 方向 | 文档 |
|------|------|
| **本专题（§3.5.2）** | [演进总览 §5.3](../reports/deepseek-version-lineage-20260625.md#v4-disk-prefix-cache) |
| **infra 线 ⑤ 子项** | [基础设施线导读 §1](../reports/deepseek-infra-line.md#1-演进链kv--offload) |
| **前置 layout** | [v4-kv-layout.md](./v4-kv-layout.md) |
| **并列 HiSparse** | [v4-hisparse.md](./v4-hisparse.md) |
| **V4 总览** | [v4.md §推理 infra](./v4.md#推理-infra-关注点) |
...
| [演进总览 §5.4](../reports/deepseek-version-lineage-20260625.md#54-三代-offload-对比) | 磁盘 prefix 在三代 offload 表中的位置 |
| [v4-hetero-kv.svg](../figures/v4/v4-hetero-kv.svg) | 异构 cache 总览图 |
