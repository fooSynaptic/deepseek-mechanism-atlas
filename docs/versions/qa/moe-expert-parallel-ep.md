...
**Shared experts** 不走稀疏 scatter：每层 **恒激活**，与 routed 输出 **[相加](../deepseek-moe.md)**。
...
V3 训练文档常并列 **[DualPipe、DeepEP、FP8](../v3.md#v3-structure-excluded)**：**DeepEP** 是 **MoE token dispatch 的通信库**，属于 **训推系统层**，不是 Transformer 权重结构。
