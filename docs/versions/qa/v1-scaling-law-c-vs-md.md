...
[← 返回演进总览 §3.1 V1](../../reports/deepseek-version-lineage-20260625.md#31-deepseek-llm-v1) · [← V1 §3 Scaling Laws](../v1.md#3-scaling-laws) · [答疑目录](./README.md)
...
| $C=MD$ 意味着 7B/67B 必须同 $D$ | $C=M\cdot D$ 是乘法 **定义**；产品统一 2T 是 **工程选择**，见 [Scaling-Law 选择性应用](../qa/v1-scaling-law-c-vs-md.md) |
...
| 文档 | 内容 |
|------|------|
| [V1 §3.2 最优 model/data Scaling](../v1.md#32-最优模型数据-scaling) | Formula 2–4 原文与 Figure 4 |
| [Scaling 答疑](./v1-scaling-law-c-vs-md.md) | $M$ 推导、Formula 1/4 数值、4B 实战 |
| [Scaling-Law 选择性应用](../qa/v1-scaling-law-c-vs-md.md) | Figure 3/4/5 分工；2T 产品 vs IsoFLOP 谷底 |
| [产品训练与 Scaling Law](../qa/v1-scaling-law-c-vs-md.md) | 7B/67B 同训 2T 与 compute-optimal 的区别 |
