...
[即 $(X')_i$ 是各条流的 **凸组合** → **单层不放大** 最大流范数](../mhc-manifold-hyper-connections.md#33-为何-mhc-需要这个约束)。
...
| 文档 | 内容 |
|------|------|
| [mHC§3](../mhc-manifold-hyper-connections.md#3-mhc-核心双随机流形约束) | 双随机定义 · Sinkhorn · 与 HC 对照 |
| [Hyper-Connections](../hyper-connections.md) | 无约束 HC 为何不 stable |
