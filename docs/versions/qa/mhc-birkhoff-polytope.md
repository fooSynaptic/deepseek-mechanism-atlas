...
[← 返回 mHC §3.2](../mhc-manifold-hyper-connections.md#32-birkhoff-多面体) · [§3 双随机流形](../mhc-manifold-hyper-connections.md#3-mhc-核心双随机流形约束) · [HC 基础](../hyper-connections.md) · [答疑目录](./README.md)
...
与 [mHC §3.4](../mhc-manifold-hyper-connections.md#34-sinkhornknoop-投影) 的 **Sinkhorn–Knopp** 投影配合：无约束 $\tilde{H}$ → 逼近 $H \in \mathcal{B}_n$。
...
即 $(X')_i$ 是各条流的 **凸组合** → **单层不放大** 最大流范数（见 [§3.3](../mhc-manifold-hyper-connections.md#33-为何-mhc-需要这个约束)）。
...
| 文档 | 内容 |
|------|------|
| [mhc-manifold-hyper-connections.md §3](../mhc-manifold-hyper-connections.md#3-mhc-核心双随机流形约束) | 双随机定义 · Sinkhorn · 与 HC 对照 |
| [hyper-connections.md](../hyper-connections.md) | 无约束 HC 为何不 stable |
