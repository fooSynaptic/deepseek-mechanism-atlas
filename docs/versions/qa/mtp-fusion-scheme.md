...
> [← 中文导读](../../README.md) · [← 仓库首页（EN）](../../../README.md) · 旧图 [MTP 投机解码总览图](../figures/mtp-speculative.svg) 是「训练结构 + 投机对照」总览；**本文 + [MTP 融合 scheme 图](../figures/mtp-fusion-scheme.svg)** 只讲 **中间 token 怎么融进 MTP 链**。
