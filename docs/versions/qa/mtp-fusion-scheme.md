...
[← V3 §三 MTP](../v3.md#三mtp-multi-token-predictionv3-新增顶层结构) · [← 投机解码专文 §2](../dspark-speculative-decoding.md#2-deepseek-路线mtpv3--v4) · [融合 scheme SVG](../figures/mtp-fusion-scheme.svg) · [答疑目录](./README.md)

> [← 中文导读](../../README.md) · [← 仓库首页（EN）](../../../README.md) · 旧图 [mtp-speculative.svg](../figures/mtp-speculative.svg) 是「训练结构 + 投机对照」总览；**本文 + [mtp-fusion-scheme.svg](../figures/mtp-fusion-scheme.svg)** 只讲 **中间 token 怎么融进 MTP 链**。
...
| [酱紫君解读 §MTP](../../reports/zhihu-jiangzijun-dspark-highlights-20260627.md#mtp一次前向如何融合中间-token) |
| [投机解码专文 §2](../dspark-speculative-decoding.md#2-deepseek-路线mtpv3--v4) |
