...
[← 返回 KV Layout §为何单一 layout 不够](../v4-kv-layout.md#为什么-v3v32-的单一-layout-不够) · [Classical 池](../v4-kv-layout.md#classical-kv-cache) · [State 池](../v4-kv-layout.md#state-cache) · [Tail buffer](./v4-tail-buffer.md) · [SWA](./v4-swa-sliding-window.md) · [答疑目录](./README.md)
...
| 能否落盘 / offload | CSA/HCA 块 **优先**（紧凑、不变） | 通常 **跟请求走**；SWA 还有三档策略（[磁盘 prefix](../v4-disk-prefix-cache.md)） |
...
| prefix 命中时要拷贝 **半块垃圾** | 命中后只需 **[重算 / 补 tail + SWA](../v4-disk-prefix-cache.md)** |
...
| 文档 | 内容 |
|------|------|
| [V4 KV Layout](../v4-kv-layout.md) | Classical + State 双池定义 |
| [V4 里的 Tail buffer 是什么？](./v4-tail-buffer.md) | Tail 生命周期 |
| [V4 里的 SWA是什么？](./v4-swa-sliding-window.md) | SWA 为何独立 eviction |
| [V4 HiSparse](../v4-hisparse.md) | 为何 offload 主要针对 Classical 里 inactive C4 |
