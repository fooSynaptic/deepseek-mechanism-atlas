...
二者都在 **State cache**，但 eviction、prefix 策略 **各自独立**（见 [v4-kv-layout.md](../v4-kv-layout.md#state-cache)）。
...
| 文档 | 内容 |
|------|------|
| [v4-kv-layout.md](../v4-kv-layout.md) | Classical vs State 分工 |
| [csa-hca-mixed-attention.md §4](../csa-hca-mixed-attention.md#v4-mixed-attention) | 五类对象对照表 |
