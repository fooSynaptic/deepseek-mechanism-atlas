...
|------|----------------|----------------|
| **CUDA Core** | 通用标量/向量运算、控制流、部分 epilogue | FP8 反量化、partial sum **FP32 续累加**（[fp8-mma-term.md](./fp8-mma-term.md)） |
...
| **MMA** | **Tensor Core 指令** | Matrix Multiply-Accumulate（[fp8-mma-term.md](./fp8-mma-term.md)） |
...
| [fp8-mma-term.md](./fp8-mma-term.md) | SM 内 Tensor Core vs CUDA Core 分工 |
