...
| **上游 ② DSA** | [DSA 稀疏注意力](./dsa-sparse-attention.md) · [DSA 逻辑详解](../dsa/dsa-logic.md) |
| **上游 ① MLA** | [MLA 低秩注意力](./mla-latent-attention.md)（V4 不再单一 per-token latent） |
| **同代 V4 其他组件** | [DeepSeek-V4](./v4.md)（两个规格、MoE） · [Muon](./muon-optimizer.md) · [mHC](./mhc-manifold-hyper-connections.md)（残差路径，与 Attention **正交**） |
...
[图示详情](../figures/v4/v4-hetero-kv.svg) · [演进总览 §3.7](../reports/deepseek-version-lineage-20260625.md#37-deepseek-v4)

**内存布局**→ **[V4 KV Layout 专文](./v4-kv-layout.md)**，算法对象与引擎池化的分界见该文 §1。
...
详见 [DeepSeek-V4 梗概§1M context 效率](./v4.md#1m-context-效率相对-v32)。

---

## 6. 训练侧：渐进式上下文

V4 训练采用 **渐进拉长上下文**（[DeepSeek-V4 梗概§训练要点](./v4.md#训练要点)）：
...
完整 **基础设施线** 见 [基础设施线导读](../reports/deepseek-infra-line.md#1-演进链kv--offload)。
...
| 方向 | 文档 |
|------|------|
| 版本总览 | [DeepSeek-V4](./v4.md)（两个规格、MoE、训练要点） · [Muon](./muon-optimizer.md) |
| 上游 | [DeepSeek-V3.2](./v3-2.md) · [DSA 稀疏注意力](./dsa-sparse-attention.md) |
| 并行（V3.2 infra） | [Index Share 梗概](./index-share.md) — 纯 infra，与 V4 路线 **互补** |
| 同代残差 | [mHC](./mhc-manifold-hyper-connections.md) |
