...
[图示详情](../figures/v4/v4-hetero-kv.svg)
...
| **生命周期** | 随 prefix 增长 append；压缩完成后 entry **不可变**，适合 **[prefix 共享与落盘](./v4-disk-prefix-cache.md)** |
...
| **上游 ④ ESS** | [ESS Latent offload](./ess-latent-cache-offload.md) |
| **算法依赖** | [CSA / HCA](./csa-hca-mixed-attention.md) · [V4 梗概](./v4.md) · [算法线 §③](../reports/deepseek-algorithm-line.md#1-演进链attention--残差) |
...
| [V4 异构 KV 总览图](../figures/v4/v4-hetero-kv.svg) | Classical + HiSparse 分层示意图 |
