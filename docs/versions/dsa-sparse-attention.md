...
[直接打开 SVG](../dsa/diagrams/dsa-pipeline.svg) · [系列目录](../dsa/README.md)
...
```
Query h_t ──► Lightning Indexer ◄── 全长 latent 历史
                  │
                  ▼ top-k (2048)
              Core MLA Attention ──► 输出
                  ▲
            被选中的 Latent-Cache entries
```
...
| **上游 ① 同质 MLA KV** | [mla-latent-attention.md](./mla-latent-attention.md) |
| **下游 ③ Index Share** | [index-share.md](./index-share.md)（indexer 算力，**并列**） |
| **下游 ④ ESS** | [ess-latent-cache-offload.md](./ess-latent-cache-offload.md)（Latent offload，**并列**） |
| **下游 ⑤ V4 infra** | [v4.md §推理 infra](./v4.md#推理-infra-关注点) · [KV layout](./v4-kv-layout.md) · [HiSparse](./v4-hisparse.md) · [磁盘 prefix](./v4-disk-prefix-cache.md) |
...
| **上游 ① MLA** | [mla-latent-attention.md](./mla-latent-attention.md) |
| **下游 ③ CSA/HCA** | [csa-hca-mixed-attention.md](./csa-hca-mixed-attention.md) · [v4.md](./v4.md) |
...
| **Index Share** | **不改 DSA 算法**；跨层复用 top-$k$ index，减 indexer 重复计算（[index-share.md](./index-share.md)） |
...
- **MLA**：K/V 压入 latent 再缓存（见 [mla-latent-attention.md](./mla-latent-attention.md)）
- **DSA**：在 MLA latent **序列**上增加「选哪些位置参与 attention」
- V3.1 **Hybrid**（Prefill MHA / Decode MQA）仍是 DSA 的前置（[v3-1.md](./v3-1.md)）
...
| 资源 | 说明 |
|------|------|
| [../dsa/lightning-indexer.md](../dsa/lightning-indexer.md) | **Lightning Indexer** 公式、Indexer-Cache、与滑动窗对比 |
| [../dsa/dsa-logic.md](../dsa/dsa-logic.md) | 完整机制、与 Hybrid/ESS/Engram 关系 |
| [../dsa/index-share-logic.md](../dsa/index-share-logic.md) | Index Share `FFFS` 模式 |
| [v3-2.md](./v3-2.md) | V3.2 版本梗概 |
