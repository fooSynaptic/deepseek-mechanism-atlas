...
> [← 中文导读](../README.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览 §5.2](../reports/deepseek-version-lineage-20260625.md#52-v32indexer-cache--latent-cache-分离--ess) · [← ESS 概念页](./ess-latent-cache-offload.md) · [← 基础设施线导读](../reports/deepseek-infra-line.md) · [DSA](./dsa-sparse-attention.md)  
...
> 图/表优先 **手动截图** 放入 [`screenshots/`](../figures/ess/paper/screenshots/)，运行 `python3 scripts/figures/ess/install_screenshot.py --inbox`；未手动的图仍可用 `python3 scripts/figures/ess/extract_paper_figures.py` 从 PDF 裁剪。
...
<img src="../figures/ess/paper/fig-3.png" alt="Figure 3. Latent-Cache Offload-Prefetch Timing in the PD disaggregation Setting" width="920"/>

*Figure 3. Latent-Cache Offload-Prefetch Timing in the PD disaggregation Setting.*

[直接打开](../figures/ess/paper/fig-3.png)
...
<img src="../figures/ess/paper/fig-1.png" alt="Figure 1. Relationship Between Throughput and Batch Size" width="720"/>

[直接打开](../figures/ess/paper/fig-1.png)
...
<img src="../figures/ess/paper/fig-2.png" alt="Figure 2. Intra-Layer Similarity Across Different Context Lengths" width="920"/>

*Figure 2. Intra-Layer Similarity Across Different Context Lengths.*

[直接打开](../figures/ess/paper/fig-2.png)
...
<img src="../figures/ess/paper/fig-4.png" alt="Figure 4. Effect of LRU-Warmup on Early Decode Cache Miss Count" width="920"/>

[直接打开](../figures/ess/paper/fig-4.png)
...
<img src="../figures/ess/paper/fig-5.png" alt="Figure 5. Intra-Layer Cache Miss Analysis" width="920"/>

[直接打开](../figures/ess/paper/fig-5.png)
...
<img src="../figures/ess/paper/fig-6.png" alt="Figure 6. Comparison of Overlap Strategies" width="920"/>

[Fig.6 直接打开](../figures/ess/paper/fig-6.png)

<img src="../figures/ess/paper/fig-7.png" alt="Figure 7. Overhead Comparison of Overlap Strategies" width="920"/>

[Fig.7 直接打开](../figures/ess/paper/fig-7.png)
...
<img src="../figures/ess/paper/fig-8.png" alt="Figure 8. Cache Miss Count Comparison Across Different Context Lengths" width="920"/>

[直接打开](../figures/ess/paper/fig-8.png)
...
<img src="../figures/ess/paper/fig-9.png" alt="Figure 9. Cache Miss Behavior Across Different Context Lengths" width="920"/>

[直接打开](../figures/ess/paper/fig-9.png)
...
<img src="../figures/ess/paper/table-1.png" alt="Table 1. Basic Setting" width="720"/>

[直接打开](../figures/ess/paper/table-1.png)
...
<img src="../figures/ess/paper/table-2.png" alt="Table 2. Throughput and OTPS Under Different MTP and Acceptance Settings" width="720"/>

[直接打开](../figures/ess/paper/table-2.png)
...
- **本地对照**：[ess-latent-cache-offload.md](./ess-latent-cache-offload.md) 概念页 · [dsa-sparse-attention.md](./dsa-sparse-attention.md) 算法前置 · [Index Share](./index-share.md) 正交 infra 补丁。
