...
[直接打开 SVG](./figures/mtp-speculative.svg) · [V3 §三 MTP](./v3.md#三mtp-multi-token-predictionv3-新增顶层结构)
...
| 层级 | 投机解码 / DSpark |
|------|-------------------|
| 模型结构 | MTP 属 **架构-train**（见 [演进总览 §1.1](../reports/deepseek-version-lineage-20260625.md#优化方向分类)） |
