...
- 前置阅读：[Hyper-Connections](hyper-connections.md)。
...
| 模块 | 演进 |
|------|------|
| Attention | GQA → [sliding window（SWA）](./qa/v4-swa-sliding-window.md#行业链) → **MLA** → **DSA** → **[CSA/HCA](./csa-hca-mixed-attention.md)** |
| FFN | GeLU → SwiGLU → **MoE** |
...
| **同代 Attention** | [CSA / HCA](./csa-hca-mixed-attention.md) · [DeepSeek-V4](./v4.md) |
| **Attention 上游** | [MLA 低秩注意力](./mla-latent-attention.md) · [DSA 稀疏注意力](./dsa-sparse-attention.md) |
...
详见 [DeepSeek-V4](./v4.md) 与 [演进总览 §3.7](../reports/deepseek-version-lineage-20260625.md#37-deepseek-v4)。
...
| 同代 V4 组件 | [CSA / HCA](./csa-hca-mixed-attention.md) · [Muon](./muon-optimizer.md) · [DeepSeek-V4](./v4.md)（Hash MoE） |
| 对比（无 mHC 的上一档） | [DeepSeek-V3.2](./v3-2.md) |
