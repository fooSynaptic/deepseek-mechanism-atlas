...
| **下游（约束版）** | [mHC](./mhc-manifold-hyper-connections.md)（含 [§3 双随机流形](./mhc-manifold-hyper-connections.md#3-mhc-核心双随机流形约束)） |
...
**mHC 的修复**：把上述混合矩阵 **投影到双随机流形** $\mathcal{B}_n$，使混合变为 **凸组合 / 加权平均** → 见 [mHC §3](./mhc-manifold-hyper-connections.md#3-mhc-核心双随机流形约束)。
...
| 文档 | **本文** | [mHC](./mhc-manifold-hyper-connections.md) |
...
| **同代 V4** | [DeepSeek-V4](./v4.md) · [CSA/HCA](./csa-hca-mixed-attention.md) |
