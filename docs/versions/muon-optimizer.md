...
> [← 中文导读](../README.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览 §3.7](../reports/deepseek-version-lineage-20260625.md#37-deepseek-v4) · [V4 梗概](./v4.md) · [CSA/HCA](./csa-hca-mixed-attention.md) · [mHC](./mhc-manifold-hyper-connections.md) · [Hash MoE + FP4](./hash-moe-fp4.md)
...
| **版本总览** | [DeepSeek-V4](./v4.md)（CSA/HCA、mHC、MoE、训练要点） |
| **演进总览** | [§3.7 DeepSeek-V4](../reports/deepseek-version-lineage-20260625.md#37-deepseek-v4) |
| **三轴图** | [架构-train 轴上的 Muon](../reports/deepseek-version-lineage-20260625.md)（100% 训练侧） |
...
Muon 与 CSA/HCA、mHC、Hash MoE **同期打包**进 V4，**难以单独 ablation** 优化器 vs 架构（见 [V4 定位](./v4.md#定位)）。
...
| 方向 | 文档 |
|------|------|
| 版本梗概 | [DeepSeek-V4](./v4.md) |
| 同代 Attention | [CSA / HCA](./csa-hca-mixed-attention.md) |
| 同代残差 | [mHC](./mhc-manifold-hyper-connections.md) |
| 同代 MoE | [Hash MoE + FP4](./hash-moe-fp4.md) |
| 演进总览 | [§3.7 V4](../reports/deepseek-version-lineage-20260625.md#37-deepseek-v4) |
