...
> **PDF**：[2401.02954.pdf](https://arxiv.org/pdf/2401.02954) · 图件见 [Scaling Laws 图件](./v1.md#3-scaling-laws) · [BBPE 词表专文](./v1-bbpe-tokenizer.md)
...
- 本仓库提供 **完整中文译文**（Figure 2–5 / Table 3–4）。
...
[图示详情](../figures/v1/bbpe/bbpe-process-example.svg) · 详述见 [BBPE 专文 §2](./v1-bbpe-tokenizer.md#bbpe-overview)
