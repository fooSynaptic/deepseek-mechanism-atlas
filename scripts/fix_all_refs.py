#!/usr/bin/env python3
"""修复 deepseek-everything 仓内全部本地链接，确保无断链、无项目外引用。"""
...
BULK_REPLACEMENTS: list[tuple[str, str]] = [
    ("../deepseek-everything/docs/", "../../../docs/"),
    ("../deepseek-everything/《ds-技术报告》/", "../../../《ds-技术报告》/"),
    ("../deepseek-everything/dsa/", "docs/dsa/"),
