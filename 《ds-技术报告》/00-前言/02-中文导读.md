...
本仓库的一大特性是**连贯、友好的阅读体验**：从 [中文导读](02-中文导读.md) 或 [演进总览](../01-总览/01-版本演进总览.md) 进入任意梗概、逻辑详解或 `qa/` 答疑后，文首均有**反向引用**——可一键回到来源章节、专题索引、[仓库首页（EN）](../README.md)。深入 DSA / Engram / MTP 等子专题后，同样能沿链接原路返回，阅读路径不断档。
