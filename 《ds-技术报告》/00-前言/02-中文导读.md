...
> **新增 · Agent 运行时线**：[DeepSeek Harness（`dsh`）](../10-Agent运行时/01-DeepSeek-Harness.md) — Cordis 插件 · Code Mode · session log；与算法 / 基础设施 / MoE 三线并列。
>
> **新增 · V4.1-Flash**：[KV 极限压缩梗概](../04-版本代际/03b-V4.1-Flash.md) — CED · CSA2 · FP4 main KV · SWA Bounded Replay。
...
| [**V4.1-Flash**](../04-版本代际/03b-V4.1-Flash.md) | CED + CSA2 + FP4 KV；全局 KV ≈ 890 B/token |
...
| [**DeepSeek Harness**](../10-Agent运行时/01-DeepSeek-Harness.md) | Agent 运行时：Everything is a plugin · Code Mode |
...
- **Agent 运行时**：[**DeepSeek Harness**](../10-Agent运行时/01-DeepSeek-Harness.md)（`dsh`）—— Cordis 插件化 coding agent；与算法 / infra / MoE 三线并列的第四条叙事。
