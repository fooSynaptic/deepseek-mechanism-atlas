...
> **arXiv**：[2501.12948](https://arxiv.org/abs/2501.12948) · **PDF**：[src/deepseek-r1-2501.12948.pdf](../09-附录/material/papers/deepseek-r1/src/deepseek-r1-2501.12948.pdf)  
> **基座**：DeepSeek-V3 Base
...
| [training-pipeline.md](../09-附录/material/papers/deepseek-r1/training-pipeline.md) | 本文 |
| [diagrams/deepseek-r1-training-pipeline.svg](../09-附录/material/papers/deepseek-r1/diagrams/deepseek-r1-training-pipeline.svg) | 自绘流程图 |
| [assets/figures/training-pipeline-reference.png](../09-附录/material/papers/deepseek-r1/assets/figures/training-pipeline-reference.png) | 外部参考图 |
| [src/deepseek-r1-2501.12948.pdf](../09-附录/material/papers/deepseek-r1/src/deepseek-r1-2501.12948.pdf) | 原文 |
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [GRPO 长程任务局限（社区解读）](04-GRPO长程局限.md) | [DeepSeek-LLM V1](../04-版本代际/00-V1-LLM.md) |
