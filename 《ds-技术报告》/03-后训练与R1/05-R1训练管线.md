...
| [R1 训练管线流程图](../09-附录/material/papers/deepseek-r1/diagrams/deepseek-r1-training-pipeline.svg) | 自绘流程图 |
| [R1 训练管线参考图](../09-附录/material/papers/deepseek-r1/assets/figures/training-pipeline-reference.png) | 外部参考图 |
