...
- DSA 的 **Indexer-Cache / Latent-Cache** = 异构 **KV 存储**（见 [dsa-logic §4](03-DSA逻辑详解.md#4-异构-kv-cacheindexer-cache-与-latent-cache)）；
- IndexCache 的 **index-cache** = **top-$k$ 下标**的跨层复用缓存；
- [ESS](../06-推理基础设施/01-ESS概念.md) 管 **Latent** 搬移，Index Share 管 **indexer 算子**次数，二者正交。

> **梗概（归属表）**：[docs/versions/index-share.md](05-Index-Share梗概.md#技术归属先读)
...
[直接打开 SVG](figures/index-share-fffs.svg)
...
| **V4 HiSparse** | V4 异构 KV + 磁盘 prefix | 不同代际，非 V3.2 补丁；见 [HiSparse](../06-推理基础设施/06-V4-HiSparse.md) · [磁盘 prefix](../06-推理基础设施/07-V4-磁盘Prefix-Cache.md) |
...
> **返回 DSA**：[dsa-logic.md §4 异构 KV Cache](03-DSA逻辑详解.md#4-异构-kv-cacheindexer-cache-与-latent-cache)
...
- 前置：[dsa-logic.md](03-DSA逻辑详解.md)
- 梗概：[index-share.md](05-Index-Share梗概.md)
- 演进全景：[deepseek-version-lineage-20260625.md](../01-总览/01-版本演进总览.md)
