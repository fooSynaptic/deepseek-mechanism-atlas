...
| 文档 | 内容 |
|------|------|
| [Lightning Indexer 详解](../04-Lightning-Indexer详解.md) | $q_t$ 对 $k_s$ 打分、$O(L^2)$ 常数极小 |
| [DSA 稀疏注意力](../02-DSA梗概.md) | DSA 流水线总览 |
| [CSA / HCA](../../04-版本代际/05-CSA-HCA混合压缩注意力.md) | CSA 4:1 块 + indexer 在 V4 栈中的位置 |
