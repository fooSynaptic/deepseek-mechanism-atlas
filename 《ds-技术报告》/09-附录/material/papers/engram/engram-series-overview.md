...
[图示详情](diagrams/engram-00-series-lineage.svg)
...
[图示详情](diagrams/engram-01b-backbone-placement.svg)
...
[图示详情](diagrams/engram-01c-forward-dataflow.svg)
...
[图示详情](diagrams/engram-01d-multi-head-hash.svg)
...
在**等参、等 FLOPs** 下扫描分配比 **ρ**（inactive 参数预算中 MoE 专家占比；ρ=1 为纯 MoE），纵轴为 **Validation Loss**：
...
[图示详情](diagrams/engram-02b-cxl-hardware-topology.svg)
...
[图示详情](diagrams/engram-02c-cxl-cache-access.svg)
...
[图示详情](diagrams/engram-03-hot-cold-tier.svg)
...
<img src="assets/figures/nine-2601.16531/fig1-two-tier-architecture.png" alt="Engram-Nine 双层检索架构" width="920"/>
...
<img src="assets/figures/nine-2601.16531/table3-val-loss-summary.png" alt="各配置 val loss 与 hot_cold_delta 汇总" width="920"/>
...
<img src="assets/figures/nine-2601.16531/fig2-hot-cold-flip.png" alt="Hot/Cold flip 训练动力学" width="920"/>

<img src="assets/figures/nine-2601.16531/table4-flip-timing.png" alt="Flip 时刻与前后最大优势" width="920"/>
...
<img src="assets/figures/nine-2601.16531/table5-nhot-ablation.png" alt="N_hot 消融：flip 时刻与稀疏度假设证伪" width="920"/>
...
<img src="assets/figures/nine-2601.16531/fig3-gate-evolution.png" alt="门控权重 α 随训练演化" width="920"/>

<img src="assets/figures/nine-2601.16531/table6-alpha-bucket.png" alt="按 α 分桶的 loss 与 hot 占比" width="920"/>

<img src="assets/figures/nine-2601.16531/fig4-gate-mismatch.png" alt="门控错配：高 α 对应高 loss" width="920"/>

**补充 — Figure 5**：深层（Layer 6）$\Delta\alpha$ 可出现反转，Nine 配置更明显。

<img src="assets/figures/nine-2601.16531/fig5-layer-alpha-reversal.png" alt="各层门控偏好 Δα" width="720"/>
