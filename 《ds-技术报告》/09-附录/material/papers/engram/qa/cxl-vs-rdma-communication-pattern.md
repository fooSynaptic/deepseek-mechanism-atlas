...
[← 返回 §RDMA 对比](../../../../../07-Engram/02-Engram系列导读.md#与-rdma-池的访问逻辑对比) · [02c 时序图（已标注）](../diagrams/engram-02c-cxl-cache-access.svg) · [L1–L3 存储](cxl-l1-l2-l3-memory-tiers.md) · [为何选 CXL 非 RDMA](cxl-why-cxl-not-rdma.md) · [prefetch window](cxl-prefetch-window-cpu-gpu.md) · [答疑目录](README.md)
