...
| 步骤 | 典型位置 | 说明 |
|------|----------|------|
[| hash / offsets | **CPU + L2** | 只依赖 input ids](../diagrams/engram-01d-multi-head-hash.svg) |
...
- [DeepSeek Engram 系列导读§② 三级存储](../../../../../07-Engram/02-Engram系列导读.md#体系结构三级存储分层)
...
- CXL 论文 arXiv:2603.10087 · [CXL 论文 PDF](../src/cxl-2603.10087.pdf)
