...
> [← 中文导读](../../../../00-前言/02-中文导读.md) · [← RL 笔记索引](../../../../03-后训练与R1/03-RL笔记索引.md) · [← 演进总览 §3.4 R1](../../../../01-总览/01-版本演进总览.md#34-deepseek-r1) · [《ds-技术报告》](../../../../01-总览/01-版本演进总览.md#34-deepseek-r1)
> **论文**：DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning
> **arXiv**：[2501.12948](https://arxiv.org/abs/2501.12948) · **PDF**：[DeepSeek-R1 论文 PDF](src/deepseek-r1-2501.12948.pdf)
> **基座**：DeepSeek-V3 Base

![Pipeline 总览](diagrams/deepseek-r1-training-pipeline.svg)

[参考图（公众号整理版）](assets/figures/training-pipeline-reference.png)
...
<img src="diagrams/deepseek-r1-training-branch.svg" alt="V3 Base 分叉：纯 RL → R1-Zero vs 四阶段 → R1" width="920"/>

[图示详情](diagrams/deepseek-r1-training-branch.svg)
...
<img src="diagrams/deepseek-r1-refinement-chain.svg" alt="Dev-2 / R1-Zero / V3 → 采样 → Filter → Refine → SFT 混合数据" width="920"/>

[图示详情](diagrams/deepseek-r1-refinement-chain.svg)
...
| [DeepSeek-R1 训练 Pipeline](training-pipeline.md) | 本文 |
| [R1 训练管线流程图](diagrams/deepseek-r1-training-pipeline.svg) | 自绘流程图 |
| [R1 训练管线参考图](assets/figures/training-pipeline-reference.png) | 外部参考图 |
| [DeepSeek-R1 论文 PDF](src/deepseek-r1-2501.12948.pdf) | 原文 |
