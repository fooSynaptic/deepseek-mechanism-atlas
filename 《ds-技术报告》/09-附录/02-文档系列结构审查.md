...
> **入口**：[版本演进总览](../01-总览/01-版本演进总览.md) · [《ds-技术报告》](../README.md) · [书中总览](../01-总览/01-版本演进总览.md)
...
| 层级 | 路径 |
|------|------|
| **总览 hub** | [deepseek-version-lineage-20260625.md](../01-总览/01-版本演进总览.md) |
| 三线导读 | [算法线](../01-总览/05-算法线导读.md) · [基础设施线](../01-总览/06-基础设施线导读.md) · [MoE 线](../01-总览/07-MoE线导读.md) |
| 版本梗概 | [docs/versions/](../01-总览/02-版本梗概索引.md) |
| 专题卷 | [docs/dsa/](../05-DSA稀疏注意力/01-系列导读.md) · [docs/rl/](../03-后训练与R1/03-RL笔记索引.md) · [docs/engram/](../07-Engram/01-Engram官方README.md) |
| 答疑 | [docs/versions/qa/](../01-总览/qa/README.md) |
...
| [../dsa/dsa-logic.md](../05-DSA稀疏注意力/03-DSA逻辑详解.md) · [index-share-logic.md](../05-DSA稀疏注意力/06-Index-Share逻辑.md) | 顶栏改为 blockquote + §3.6 锚点 |
| [spec-decode-draft-acceleration-20260604.md](../06-推理基础设施/03-投机解码自测加速比.md) | 顶栏合并为 blockquote |
| [docs/engram/README.md](../07-Engram/01-Engram官方README.md) | hr 下 blockquote → §7 专题关系 |
| [docs/versions/qa/README.md](../01-总览/qa/README.md) | blockquote → 梗概索引 / 演进总览 |
| [v1-technical-report.zh.md](../04-版本代际/00-V1-LLM.md) · [deepseek-llm-v1-highlights.md](../04-版本代际/00-V1-LLM.md) | stub 页补 §3.1 回链 |

### 3.2 反向引用（总览 → 子文）

演进总览 §3 各版本节已链到对应梗概 / 专文（含 [FP8 动态量化 §3.3](../02-基座架构/06-V3-FP8动态量化.md)）。§7 专题表链 Engram / R1 管线等。

**建议**（非阻塞）：§7 可增补 DSA 系列、[ESS 概念](../06-推理基础设施/01-ESS概念.md)、[Index Share](../05-DSA稀疏注意力/05-Index-Share梗概.md) 一行，与三线导读 §5 反向表完全对称。
...
| 概念 | 唯一主文档 | 摘要嵌入 | 答疑 |
|------|-----------|----------|------|
| FP8 训练量化 | [v3-fp8-dynamic-quantization.md](../02-基座架构/06-V3-FP8动态量化.md) | [v3.md §附 FP8](../02-基座架构/01-V3基座.md) 同图同链 | [fp8-partial-sum-drift.md](../02-基座架构/qa/fp8-partial-sum-drift.md)（机制）；[fp8-mma-term.md](../02-基座架构/qa/fp8-mma-term.md)（**术语表**，非第二篇机制文） |
...
| DSA 管线 | [dsa-logic.md](../05-DSA稀疏注意力/03-DSA逻辑详解.md) | 梗概 / Raschka 链同一 `dsa-pipeline.svg` | — |
| ESS 双 Cache | [ess-latent-cache-offload.md](../06-推理基础设施/01-ESS概念.md) | DSA 系列 / Lightning Indexer **同一路径** | [h2d-d2h-pcie-transfer.md](../06-推理基础设施/qa/h2d-d2h-pcie-transfer.md) |
| V1 译文 | **已并入** [v1.md](../04-版本代际/00-V1-LLM.md) | stub 页仅重定向 | — |
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [开发索引（非阅读入口）](01-开发索引.md) | [全书目录](../README.md) |
