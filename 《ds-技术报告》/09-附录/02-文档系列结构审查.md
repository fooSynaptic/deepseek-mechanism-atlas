...
| 概念 | 唯一主文档 | 摘要嵌入 | 答疑 |
|------|-----------|----------|------|
| FP8 训练量化 | [v3-fp8-dynamic-quantization.md](../02-基座架构/06-V3-FP8动态量化.md) | [v3.md §附 FP8](../02-基座架构/01-V3基座.md) 同图同链 | [fp8-partial-sum-drift.md](../02-基座架构/qa/fp8-partial-sum-drift.md)；[fp8-mma-term.md](../02-基座架构/qa/fp8-mma-term.md) |
