...
> [← 演进总览 §3.8](../01-总览/01-版本演进总览.md#38-thinking-with-visual-primitives) · [← 中文导读](../00-前言/02-中文导读.md) · [← V4 梗概](../04-版本代际/03-V4.md)
> **PDF**：[Visual Primitives 原文 PDF](papers/Thinking_with_Visual_Primitives.pdf) · DeepSeek-AI + 北大 + 清华 · 2026
...
<img src="figures/visual-primitives/fig-2-architecture-pipeline.png" alt="Figure 2 — V4-Flash + ViT 架构与 Pretrain → SFT → RL → RFT → 蒸馏 训练管线" width="920"/>
...
| **V4-Flash LLM** | 继承 **[CSA](../04-版本代际/05-CSA-HCA混合压缩注意力.md)**：视觉 token 在 KV cache 再 **4× 压缩** |
...
[直接打开 Figure 2](figures/visual-primitives/fig-2-architecture-pipeline.png)
...
<img src="figures/visual-primitives/fig-3-cold-start-counting.png" alt="Figure 3 — 粗粒度与细粒度计数 cold-start 数据" width="920"/>
...
[直接打开 Figure 3](figures/visual-primitives/fig-3-cold-start-counting.png)

---

## 4. Token 效率

<img src="figures/visual-primitives/fig-1-token-efficiency.png" alt="Figure 1 — 800×800 输入下各模型 token 消耗与 benchmark 均分" width="920"/>
...
[直接打开 Figure 1](figures/visual-primitives/fig-1-token-efficiency.png)

---

## 5. Table 1 — 与前沿模型对比

<img src="figures/visual-primitives/table-1-benchmark.png" alt="Table 1 — 与 Gemini / GPT / Claude / Gemma / Qwen3-VL 对比" width="920"/>
...
[直接打开 Table 1](figures/visual-primitives/table-1-benchmark.png)
...
| 维度 | 衔接 |
|------|------|
| **基座** | **V4-Flash**（284B/13B）— 见 [演进总览 §3.7](../01-总览/01-版本演进总览.md#37-deepseek-v4) |
...
| 文件 | 论文 |
|------|------|
| [Figure 1 — Token 效率](figures/visual-primitives/fig-1-token-efficiency.png) | Figure 1 |
| [Figure 2 — 架构与训练管线](figures/visual-primitives/fig-2-architecture-pipeline.png) | Figure 2 |
| [Figure 3 — Cold-start 计数](figures/visual-primitives/fig-3-cold-start-counting.png) | Figure 3 |
| [Table 1 — Benchmark 对比](figures/visual-primitives/table-1-benchmark.png) | Table 1 |
