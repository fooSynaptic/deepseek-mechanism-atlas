...
[← 返回演进总览 §3.1 V1](../01-版本演进总览.md#31-deepseek-llm-v1) · [← V1 §3 Scaling Laws](../../04-版本代际/00-V1-LLM.md#3-scaling-laws) · [答疑目录](README.md)
...
<img src="../../04-版本代际/figures/v1/scaling-law/deepseek-table3-model-scale.png" alt="Table 3 — 6N1、6N2 相对 M 的偏差" width="920"/>

[直接打开 Table 3](../../04-版本代际/figures/v1/scaling-law/deepseek-table3-model-scale.png)
...
| 文档 | 内容 |
|------|------|
| [V1 §3.2 最优 model/data Scaling](../../04-版本代际/00-V1-LLM.md#32-最优模型数据-scaling) | Formula 2–4 原文与 Figure 4 |
