...
| 主题 | 来源 | 文件 |
|------|------|------|
| V1：$C=M\cdot D$ vs $C=6ND$ | [演进总览 §3.1 V1](../01-版本演进总览.md#31-deepseek-llm-v1) · [V1 §3](../../04-版本代际/00-V1-LLM.md#3-scaling-laws) | [为何 DeepSeek 用 $C=M\cdot D$ 而非 $C=6ND$？](v1-scaling-law-c-vs-md.md) |
| MoE centroid vs gate-weight | [DeepSeekMoE §前向公式](../../02-基座架构/05-DeepSeekMoE.md#forward-formula) | [MoE 路由：gate-weight 还是 expert centroid？](../../02-基座架构/qa/moe-centroid-vs-gate-weight.md) |
| Fine-grained vs GShard 粗专家 | [DeepSeekMoE §优化逻辑 (b)](../../02-基座架构/05-DeepSeekMoE.md#optimization-logic) | [Fine-grained Expert Segmentation：为何优于 GShard 式粗专家？](../../02-基座架构/qa/moe-fine-grained-segmentation.md) |
| Expert Parallel（EP）与 gather/scatter | [Hash MoE §1.3](../../04-版本代际/06-Hash-MoE-FP4.md#still-inherited) · [DeepSeekMoE §推理 infra](../../02-基座架构/05-DeepSeekMoE.md#推理-infra-关注点) | [MoE 推理：Expert Parallel与 gather/scatter](../../02-基座架构/qa/moe-expert-parallel-ep.md) |
| Hash MoE 为何只改浅层 | [Hash MoE §1.2](../../04-版本代际/06-Hash-MoE-FP4.md#hash-moe-routing) · [EP 答疑 §4](../../02-基座架构/qa/moe-expert-parallel-ep.md#4-hash-moe-改什么不改什么) | [Hash MoE 为何只改浅层、深层仍用 centroid 路由？](../../02-基座架构/qa/hash-moe-shallow-vs-deep.md) |
...
| H2D / D2H、PCIe prefetch | [ESS 论文梗概 §Fig.6&7](../../06-推理基础设施/02-ESS论文梗概.md#figure-67-overlap-策略对比) | [H2D / D2H 是什么？](h2d-d2h-pcie-transfer.md) |
| FP8 partial sum 漂移 | [FP8 专文 §为何需要动态量化](../../02-基座架构/06-V3-FP8动态量化.md#为何需要动态量化) | [FP8 动态量化里的 partial sum 漂移](../../02-基座架构/qa/fp8-partial-sum-drift.md) |
...
| MMA / WGMMA 名词 | [FP8 专文 一句话](../../02-基座架构/06-V3-FP8动态量化.md) · [partial sum 答疑](../../02-基座架构/qa/fp8-partial-sum-drift.md) | [名词解释：MMA](../../02-基座架构/qa/fp8-mma-term.md) |
