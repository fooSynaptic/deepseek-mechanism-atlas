...
> 更新：2026-06-25
> [← 全系列演进总览](01-版本演进总览.md) · [V1 正文](../04-版本代际/00-V1-LLM.md) · [V2](../04-版本代际/00-V2-MoE与MLA.md) · [V3](../02-基座架构/01-V3基座.md)
...
2. **V3.1 → V3.2 → V4（2025–2026）**：在同一 V3 权重架构上 post-train、加 **DSA**、再 **[架构大步进](01-版本演进总览.md#2-版本时间线与关系)**
...
<img src="figures/v1-v3-mla-evolution.svg" alt="V1 GQA → V2/V3 MLA latent KV 压缩" width="920"/>

[图示详情](figures/v1-v3-mla-evolution.svg)

- **V2 首创 MLA**（[2405.04434](https://arxiv.org/abs/2405.04434)）；**V3 沿用**同一 latent 格式（[MLA 详解](../02-基座架构/02-MLA低秩注意力.md)）
...
| **V2** | **[DeepSeekMoE](../02-基座架构/05-DeepSeekMoE.md)**：160 routed，每 token 6 个 + shared；稀疏激活降训练/推理 FFN 成本（[MoE 线 §②](07-MoE线导读.md)） |
| **V3** | 扩到 **256 experts / 8 activated**；路由改为 **sigmoid + 动态 bias**（[aux-loss-free](../02-基座架构/03-aux-loss-free-MoE路由.md)），并加 **MTP** 辅助头 |
...
<img src="figures/v1-v3-capability-timeline.svg" alt="V1 → V2 → V3 能力代际及 R1 / V3.1 / V3.2 分叉" width="920"/>

[图示详情](figures/v1-v3-capability-timeline.svg)
...
1. [V1 正文](../04-版本代际/00-V1-LLM.md)（DeepSeek-LLM 完整译文）
2. [DeepSeekMoE 架构](../02-基座架构/05-DeepSeekMoE.md) · [V2 梗概](../04-版本代际/00-V2-MoE与MLA.md) · [MLA 前向流程图](../02-基座架构/02-MLA低秩注意力.md#forward-flow)
3. [V3 梗概](../02-基座架构/01-V3基座.md) · [演进总览 §3](01-版本演进总览.md#3-各版本详解)
4. 后续代际：[R1](../03-后训练与R1/02-R1.md) → [V3.1](../04-版本代际/01-V3.1-Terminus.md) → [V3.2](../04-版本代际/02-V3.2-DSA.md) → [V4](../04-版本代际/03-V4.md)

---

## 7. 参考

- [V1 BBPE 词表专文](../04-版本代际/00-V1-BBPE词表与Tokenizer.md)
- [V1 技术报告精读 stub](../04-版本代际/00-V1-LLM.md)
