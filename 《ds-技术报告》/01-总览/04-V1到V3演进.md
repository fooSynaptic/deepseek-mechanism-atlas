...
2. **V3.1 → V3.2 → V4（2025–2026）**：在同一 V3 权重架构上 post-train、加 **DSA**、再 **架构大步进**（见 [演进总览 §2](01-版本演进总览.md#2-版本时间线与关系)）
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [DeepSeek MoE 线：稠密 FFN → DeepSeekMoE → aux-loss-free → Hash MoE](07-MoE线导读.md) | [DeepSeek 各版本梗概](02-版本梗概索引.md) |
