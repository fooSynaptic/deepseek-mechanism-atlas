...
> [← 报告目录](../01-总览/03-技术报告索引.md) · [全文解析（含表格）](02-Raschka全文解析.md) · [原文](https://magazine.sebastianraschka.com/p/technical-deepseek)  
> 作者：Sebastian Raschka · 2025-12-03（更新 2026-01-01）  
> 本地对照：[V3 梗概](../02-基座架构/01-V3基座.md) · [V3.1 梗概](../04-版本代际/01-V3.1-Terminus.md) · [V3.2 梗概](../04-版本代际/02-V3.2-DSA.md) · [MLA](../02-基座架构/02-MLA低秩注意力.md) · **[DSA 梗概](../05-DSA稀疏注意力/02-DSA梗概.md)** · [DSA 逻辑](../05-DSA稀疏注意力/03-DSA逻辑详解.md) · [RLVR](../03-后训练与R1/01-RLVR.md)
...
| 文章章节 | 本地延伸 |
|----------|----------|
| §3.1 MLA / V3 | [mla-latent-attention.md](../02-基座架构/02-MLA低秩注意力.md) · [v3.md](../02-基座架构/01-V3基座.md) |
| §3.2 RLVR / GRPO | [rlvr.md](../03-后训练与R1/01-RLVR.md) · [r1.md](../03-后训练与R1/02-R1.md) |
| §3.4 V3.1 Hybrid / MLA 切换 | [v3-1.md §MLA 模式切换](../04-版本代际/01-V3.1-Terminus.md#mla-模式切换terminus-起) |
| §4 DSA | **[lightning-indexer.md](../05-DSA稀疏注意力/04-Lightning-Indexer详解.md)** · [dsa-sparse-attention.md](../05-DSA稀疏注意力/02-DSA梗概.md) · [dsa-logic.md](../05-DSA稀疏注意力/03-DSA逻辑详解.md) |
| §6 V3.2 infra | [v3-2.md](../04-版本代际/02-V3.2-DSA.md) · [演进总览 §3.6](../01-总览/01-版本演进总览.md#36-deepseek-v32--v32-exp) |
| §8 mHC | [mhc-manifold-hyper-connections.md](../04-版本代际/04-mHC流形约束超连接.md) · [v4.md](../04-版本代际/03-V4.md) |
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [DeepSeek Engram 系列导读](../07-Engram/02-Engram系列导读.md) | [Raschka 全文解析：From DeepSeek V3 to V3.2](02-Raschka全文解析.md) |
