...
| 文章章节 | 本地延伸 |
|----------|----------|
| §3.1 MLA / V3 | [MLA 低秩注意力](../02-基座架构/02-MLA低秩注意力.md) · [DeepSeek-V3](../02-基座架构/01-V3基座.md) |
| §3.2 RLVR / GRPO | [RLVR](../03-后训练与R1/01-RLVR.md) · [DeepSeek-R1](../03-后训练与R1/02-R1.md) |
| §3.4 V3.1 Hybrid / MLA 切换 | [DeepSeek-V3.1 梗概§MLA 模式切换](../04-版本代际/01-V3.1-Terminus.md#mla-模式切换terminus-起) |
| §4 DSA | **[Lightning Indexer 详解](../05-DSA稀疏注意力/04-Lightning-Indexer详解.md)** · [DSA 稀疏注意力](../05-DSA稀疏注意力/02-DSA梗概.md) · [DSA 逻辑详解](../05-DSA稀疏注意力/03-DSA逻辑详解.md) |
| §6 V3.2 infra | [DeepSeek-V3.2](../04-版本代际/02-V3.2-DSA.md) · [演进总览 §3.6](../01-总览/01-版本演进总览.md#36-deepseek-v32--v32-exp) |
| §8 mHC | [mHC](../04-版本代际/04-mHC流形约束超连接.md) · [DeepSeek-V4](../04-版本代际/03-V4.md) |