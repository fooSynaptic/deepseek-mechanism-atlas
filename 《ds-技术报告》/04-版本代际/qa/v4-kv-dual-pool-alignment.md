...
| prefix 命中时要拷贝 **半块垃圾** | 命中后只需 **[重算 / 补 tail + SWA](../../06-推理基础设施/07-V4-磁盘Prefix-Cache.md)** |
...
| 文档 | 内容 |
|------|------|
| [V4 KV Layout](../../06-推理基础设施/05-V4-KV-Layout.md) | Classical + State 双池定义 |
| [V4 里的 Tail buffer 是什么？](v4-tail-buffer.md) | Tail 生命周期 |
| [V4 里的 SWA是什么？](v4-swa-sliding-window.md) | SWA 为何独立 eviction |
| [V4 HiSparse](../../06-推理基础设施/06-V4-HiSparse.md) | 为何 offload 主要针对 Classical 里 inactive C4 |
