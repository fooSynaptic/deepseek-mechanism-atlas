...
| 文档 | 内容 |
|------|------|
| [../../dsa/lightning-indexer.md](../../05-DSA稀疏注意力/04-Lightning-Indexer详解.md) | $q_t$ 对 $k_s$ 打分、$O(L^2)$ 常数极小 |
| [dsa-sparse-attention.md](../../05-DSA稀疏注意力/02-DSA梗概.md) | DSA 流水线总览 |
| [csa-hca-mixed-attention.md](../05-CSA-HCA混合压缩注意力.md) | CSA 4:1 块 + indexer 在 V4 栈中的位置 |
