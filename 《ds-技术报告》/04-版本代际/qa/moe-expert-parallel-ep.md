...
**Shared experts** 不走稀疏 scatter：每层 **恒激活**，与 routed 输出 **[相加](../../02-基座架构/05-DeepSeekMoE.md)**。
...
V3 训练文档常并列 **[DualPipe、DeepEP、FP8](../../02-基座架构/01-V3基座.md#v3-structure-excluded)**：**DeepEP** 是 **MoE token dispatch 的通信库**，属于 **训推系统层**，不是 Transformer 权重结构。
...
| **[device-limited routing](../../02-基座架构/qa/moe-fine-grained-segmentation.md)** | V2 限制 token 只打本地 expert，减 EP 通信 |
