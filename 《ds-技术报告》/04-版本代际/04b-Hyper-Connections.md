...
> [← 中文导读](../00-前言/02-中文导读.md) · [← 仓库首页（EN）](../../README.md) · [← mHC 主文档](04-mHC流形约束超连接.md) · [← 算法线导读](../01-总览/05-算法线导读.md) · [mHC §3 双随机流形](04-mHC流形约束超连接.md#3-mhc-核心双随机流形约束) · [V4 梗概](03-V4.md) · [Raschka §8](../08-外部解读/01-Raschka要点速读.md#结论表-7--8)  
...
| **下游（约束版）** | [mhc-manifold-hyper-connections.md](04-mHC流形约束超连接.md)（含 [§3 双随机流形](04-mHC流形约束超连接.md#3-mhc-核心双随机流形约束)） |
...
**mHC 的修复**（不在本文展开）：把上述混合矩阵 **投影到双随机流形** $\mathcal{B}_n$，使混合变为 **凸组合 / 加权平均** → 见 [mHC §3](04-mHC流形约束超连接.md#3-mhc-核心双随机流形约束)。
...
| 文档 | **本文** | [mhc-manifold-hyper-connections.md](04-mHC流形约束超连接.md) |
...
| **同代 V4** | [v4.md](03-V4.md) · [CSA/HCA](05-CSA-HCA混合压缩注意力.md) |
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [CSA / HCA 混合压缩注意力](05-CSA-HCA混合压缩注意力.md) | [mHC（Manifold-Constrained Hyper-Connections）](04-mHC流形约束超连接.md) |
