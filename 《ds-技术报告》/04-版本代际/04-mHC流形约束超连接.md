...
> [← 中文导读](../00-前言/02-中文导读.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览 §3.7](../01-总览/01-版本演进总览.md#37-deepseek-v4) · [← 算法线导读](../01-总览/05-算法线导读.md) · [← V4 梗概](03-V4.md) · [HC 基础](04b-Hyper-Connections.md) · [Raschka §8 mHC](../08-外部解读/01-Raschka要点速读.md#结论表-7--8)  
...
| 模块 | 演进 |
|------|------|
| Attention | GQA → sliding window → **MLA** → **DSA** → **[CSA/HCA](05-CSA-HCA混合压缩注意力.md)**（见 [算法线导读](../01-总览/05-算法线导读.md)） |
| FFN | GeLU → SwiGLU → **MoE** |
| **残差** | 恒等残差 → **HC** → **mHC** |
...
| **同代 Attention** | [csa-hca-mixed-attention.md](05-CSA-HCA混合压缩注意力.md) · [v4.md](03-V4.md) |
| **Attention 上游** | [mla-latent-attention.md](../02-基座架构/02-MLA低秩注意力.md) · [dsa-sparse-attention.md](../05-DSA稀疏注意力/02-DSA梗概.md) |
...
详见 [v4.md](03-V4.md) 与 [演进总览 §3.7](../01-总览/01-版本演进总览.md#37-deepseek-v4)。
...
| 同代 V4 组件 | [csa-hca-mixed-attention.md](05-CSA-HCA混合压缩注意力.md) · [v4.md](03-V4.md)（CSA、HCA、Muon、Hash MoE） |
| 对比（无 mHC 的上一档） | [v3-2.md](02-V3.2-DSA.md) |
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [Hyper-Connections（HC）](04b-Hyper-Connections.md) | [Hash MoE + FP4](06-Hash-MoE-FP4.md) |
