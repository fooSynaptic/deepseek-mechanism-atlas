...
> [← 中文导读](../00-前言/02-中文导读.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览 §3.3](../01-总览/01-版本演进总览.md#33-deepseek-v3) · [← V3 基座](01-V3基座.md) · [论文 Figure 7](https://arxiv.org/abs/2412.19437)  
...
- 结构边界：[v3.md §排除项](01-V3基座.md#v3-structure-excluded)
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [MoE sequence-wise balance loss（$L_{\mathrm{Bal}}$）](04-序列均衡损失.md) | [RLVR（Reinforcement Learning with Verifiable Rewards）](../03-后训练与R1/01-RLVR.md) |
