...
> [← 中文导读](../00-前言/02-中文导读.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览](../01-总览/01-版本演进总览.md) · [← MoE 线导读](../01-总览/07-MoE线导读.md) · [← aux-loss-free 主文档](03-aux-loss-free-MoE路由.md) · [V3 梗概](01-V3基座.md)  
...
| **主机制 ③** | [aux-loss-free-moe-routing.md](03-aux-loss-free-MoE路由.md) |
...
- [aux-loss-free-moe-routing.md](03-aux-loss-free-MoE路由.md) — $b_i$、top-$K$ 双轨
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [aux-loss-free MoE 路由逻辑](03-aux-loss-free-MoE路由.md) | [DeepSeek-V3 FP8 动态量化](06-V3-FP8动态量化.md) |
