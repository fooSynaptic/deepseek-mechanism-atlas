...
[DeepSeekMoE 把 $N$ 个大 expert 拆成 $2N$ 个小 expert](../05-DeepSeekMoE.md#optimization-logic)：
...
V4 前几层改用 **[Hash 路由](../../04-版本代际/06-Hash-MoE-FP4.md)**— 不再用 $u^\top e_i$ 做语义匹配，而是确定性 hash。
