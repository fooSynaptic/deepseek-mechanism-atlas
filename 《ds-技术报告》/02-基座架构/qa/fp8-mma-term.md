...
[← 返回 FP8 专文](../06-V3-FP8动态量化.md) · [partial sum 漂移](fp8-partial-sum-drift.md) · [答疑目录](README.md)
...
| **partial sum** | 某一输出元素在 **整条 MMA 链还没加完** 时的中间累加和（见 [fp8-partial-sum-drift.md](fp8-partial-sum-drift.md)） |
