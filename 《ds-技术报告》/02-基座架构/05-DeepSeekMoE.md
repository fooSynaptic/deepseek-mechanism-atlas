...
> [← 中文导读](../00-前言/02-中文导读.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览 §2](../01-总览/01-版本演进总览.md#2-版本时间线与关系) · [← MoE 线导读](../01-总览/07-MoE线导读.md) · [V2 首发版本](../04-版本代际/00-V2-MoE与MLA.md) · [V3 旗舰化](01-V3基座.md) · [aux-loss-free 下游](03-aux-loss-free-MoE路由.md)  
...
**DeepSeekMoE** = DeepSeek 自研的 **细粒度 routed experts + shared experts** FFN 稀疏激活框架：每 token 只激活少量 routed expert，并 **始终保留 shared expert** 路径；V2（2024-05）**首次引入**，V3 / R1 / V3.1 / V3.2 **沿用同一 MoE 骨架**，V3 起路由改为 [aux-loss-free](03-aux-loss-free-MoE路由.md)，V4 前几层改 **Hash 路由**（见 [v4.md](../04-版本代际/03-V4.md)）。
...
V2 论文相对 67B 稠密：训练成本 **-42.5%**、生成吞吐 **5.76×**（同参数量级对比语境见 [v2.md](../04-版本代际/00-V2-MoE与MLA.md)）。
...
> **版本文档**（训练规模、上下文、后训练）：[V2](../04-版本代际/00-V2-MoE与MLA.md) · [V3](01-V3基座.md) · [V4](../04-版本代际/03-V4.md)
...
| **上游 ①** | 稠密 FFN（概念阶段；V1 产品实例见 [v1.md](../04-版本代际/00-V1-LLM.md)） |
| **下游 ③④** | [aux-loss-free-moe-routing.md](03-aux-loss-free-MoE路由.md) · [moe-sequence-wise-balance-loss.md](04-序列均衡损失.md) |
| **下游 ⑤** | [hash-moe-fp4.md](../04-版本代际/06-Hash-MoE-FP4.md) · [v4.md](../04-版本代际/03-V4.md) |
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [MLA（Multi-Head Latent Attention）前向计算流程](02-MLA低秩注意力.md) | [aux-loss-free MoE 路由逻辑](03-aux-loss-free-MoE路由.md) |
