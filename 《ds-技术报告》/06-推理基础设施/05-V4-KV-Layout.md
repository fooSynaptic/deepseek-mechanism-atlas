...
> [← 中文导读](../00-前言/02-中文导读.md) · [← 仓库首页（EN）](../../README.md) · [← 演进总览 §5.3 KV layout](../01-总览/01-版本演进总览.md#v4-kv-layout) · [← 基础设施线导读](../01-总览/06-基础设施线导读.md) · [CSA/HCA 算法专文](../04-版本代际/05-CSA-HCA混合压缩注意力.md) · [V4 梗概 §推理 infra](../04-版本代际/03-V4.md#推理-infra-关注点) · [并列 HiSparse](06-V4-HiSparse.md) · [并列 磁盘 Prefix Cache](07-V4-磁盘Prefix-Cache.md) · [上游 ESS](01-ESS概念.md)  
...
[直接打开 SVG](../01-总览/figures/v4/v4-hetero-kv.svg)
...
| **生命周期** | 随 prefix 增长 append；压缩完成后 entry **不可变**，适合 **prefix 共享与落盘**（见 [磁盘 Prefix Cache](07-V4-磁盘Prefix-Cache.md)） |
...
| **上游 ④ ESS** | [ess-latent-cache-offload.md](01-ESS概念.md) |
| **算法依赖** | [csa-hca-mixed-attention.md](../04-版本代际/05-CSA-HCA混合压缩注意力.md) · [V4 梗概](../04-版本代际/03-V4.md) · [算法线 §③](../01-总览/05-算法线导读.md#1-演进链attention--残差) |
...
| [v4-hetero-kv.svg](../01-总览/figures/v4/v4-hetero-kv.svg) | Classical + HiSparse 分层示意图 |
...
| ← 上一章 | 下一章 → |
|----------|----------|
| [投机解码与 DSpark（DeepSeek 推理加速 · 唯一入口）](04-DSpark投机解码.md) | [V4 HiSparse：inactive C4 entry CPU offload](06-V4-HiSparse.md) |
