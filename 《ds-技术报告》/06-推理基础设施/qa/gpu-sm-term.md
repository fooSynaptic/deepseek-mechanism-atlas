...
|------|----------------|----------------|
| **CUDA Core** | 通用标量/向量运算、控制流、部分 epilogue | FP8 反量化、partial sum **FP32 续累加**（[名词解释：MMA](../../02-基座架构/qa/fp8-mma-term.md)） |
...
| **MMA** | **Tensor Core 指令** | Matrix Multiply-Accumulate（[名词解释：MMA](../../02-基座架构/qa/fp8-mma-term.md)） |
...
| [名词解释：MMA](../../02-基座架构/qa/fp8-mma-term.md) | SM 内 Tensor Core vs CUDA Core 分工 |
