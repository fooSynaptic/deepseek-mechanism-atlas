...
[← 返回 ESS 论文梗概 §Figure 6&7](../02-ESS论文梗概.md#figure-67-overlap-策略对比) · [← ESS 梗概 §Fig.3 / PD 时序](../02-ESS论文梗概.md#系统划分fig3) · [答疑目录](../../01-总览/qa/README.md)
...
论文报告优化后 H2D 约 **0.79 → 37 GB/s**，D2H 约 **0.23 → 43 GB/s**（Table/§3 工程数据，见 [梗概 §三大工程模块](../02-ESS论文梗概.md#三大工程模块对应-3)）。
...
- [ess-paper-highlights.md](../02-ESS论文梗概.md) — Fig.3 时序、Fig.6–7 Overlap、FlashTrans 数据
- [ess-latent-cache-offload.md](../01-ESS概念.md) — ESS 概念与双 Cache 分工
