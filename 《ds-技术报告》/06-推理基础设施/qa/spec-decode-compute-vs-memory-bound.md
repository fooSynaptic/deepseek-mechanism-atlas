...
[← 返回投机解码专文 §1.1](../04-DSpark投机解码.md#11-瓶颈每-token-搬一遍大模型权重) · [← 专文 §4 草稿范式](../04-DSpark投机解码.md#4-草稿范式总览eagle3--dflash--mtp--dspark) · [← 酱紫君解读 §Speculative Decoding](../../08-外部解读/03-酱紫君DSpark阅读笔记.md#speculative-decoding) · [答疑目录](../../01-总览/qa/README.md)
...
若顺序头也每层跑 MoE → **退化成 Eagle**，$\tau_q$ 再次 $\propto K$（[酱紫君解读 §半自回归](../../08-外部解读/03-酱紫君DSpark阅读笔记.md#dspark-半自回归草稿并行主干-vs-顺序头)）。
...
| 文档 | 锚点 / 说明 |
|------|-------------|
| [投机解码专文 §1.1](../04-DSpark投机解码.md#11-瓶颈每-token-搬一遍大模型权重) | Memory-Bound 瓶颈原文 |
| [投机解码专文 §4](../04-DSpark投机解码.md#4-草稿范式总览eagle3--dflash--mtp--dspark) | Eagle / DFlash / DSpark 范式表 |
